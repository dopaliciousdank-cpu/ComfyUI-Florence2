...
class Florence2Run:
        ...
        return {
            "required": {
                ...
                "task": (
                    ...
                    'custom_nsfw_tags',
                    'custom_nsfw_caption',
                    'custom_nsfw_detailed_caption',
                    'custom_docci_caption',
                    'custom_GPT4V_caption',
                    'HUMAN_CAPTION',
                    'LLAVA_CAPTION',
                    ],
                   ),
    ...
    def encode(self, image, text_input, florence2_model, task, fill_mask, keep_model_loaded=False, 
        ...
        prompts = {
            ...
            'custom_tags': '<TAGS>',
            'custom_nsfw_tags': '<NSFW_TAGS>',
            'custom_nsfw_caption': '<NSFW_CAPTION>',
            'custom_nsfw_detailed_caption': '<NSFW_DETAILED_CAPTION>',
            'custom_docci_caption': '<DOCCI_CAPTION>',
            'custom_GPT4V_caption': '<GPT4V_CAPTION>',
